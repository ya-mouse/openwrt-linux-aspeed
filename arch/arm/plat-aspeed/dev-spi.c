...
static struct mtd_partition ast_spi_dev_partitions[] = {
		{
			.name	= "u-boot",
			.offset = 0, /* From 0 */
			.size	= 0x30000, /* Size 192K */
			.mask_flags	= MTD_WRITEABLE,
                }, {
                        .name   = "env",
                        .offset = 0x30000, /* From 192K */
                        .size   = 0x10000, /* Size 64K, one sector */
		}, {
		        .name   = "kernel",
			.offset = 0x40000,  /* From 512K */
            		.size   = 0x200000, /* Size 2M */
        }, {
            		.name   = "rootfs",
			.offset = 0x240000, /* From 3M */
            		.size   = 0xD70000, /* Size 14M */
		}, {
			.name	= "data0",
			.offset = MTDPART_OFS_APPEND,
			.size	= MTDPART_SIZ_FULL,
...
static struct flash_platform_data spi_dev_data = {
  .type = "s25sl12801",
  .nr_parts = ARRAY_SIZE(ast_spi_dev_partitions),
  .parts = ast_spi_dev_partitions,
};
