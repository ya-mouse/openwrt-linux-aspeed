...
#if defined(CONFIG_ARCH_1100) || defined(CONFIG_ARCH_2050) || defined(CONFIG_ARCH_AST2100) || defined(CONFIG_ARCH_2200)
...
#define SCU_FUN_PIN_MAC0_MDIO	(0x1 << 20)
#define SCU_FUN_PIN_MAC0_MDC	0x0
#else
